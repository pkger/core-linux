...
templetes = {
	script = "https://raw.githubusercontent.com/pkger/core-pkgs/main/${{ pkg.name }}/script.lua",
	pkg = "https://raw.githubusercontent.com/pkger/core-pkgs/main/${{ pkg.name }}/${{ pkg.version }}/pkg.lua",
}
